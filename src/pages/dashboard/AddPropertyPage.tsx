  ...
  return (
    <div className="container-app py-8">
      <div className="mx-auto mb-5 flex w-full max-w-3xl items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-ink-900">Add a property</h1>
          <p className="text-sm text-ink-500">8 quick steps to a live listing.</p>
        </div>
      </div>
      <PropertyWizard onCancel={() => window.history.back()} />
    </div>
  );
}